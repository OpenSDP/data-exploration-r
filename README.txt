...
The purpose of this tutorial is to provide an R introduction for education data
analysts, and to demonstrate useful data exploration commands. You don't need
to know any R to do this tutorial. In Part 1, you will see how to use data
...
the data_exploration.zip file and unzip the contents into a folder on your Desktop. 
Double-click to open the data_exploration_tutorial.Rmd file using R Studio. 
As you see each grey section of code in the file viewer pane, click on the 
green arrow to run the commands. You will see the results in the window 
below. Use the results to answer the questions in the tutorial. 
